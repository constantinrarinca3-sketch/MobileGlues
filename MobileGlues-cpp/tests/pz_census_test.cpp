...
int main() {
    ...
    setenv("MOBILEGLUES_PZ_DRAW_BATCH", "0", 1);
    ...
    expect(!mg_pz_draw_batch_active, "0 must disable draw batching");
    ...
    setenv("MOBILEGLUES_PZ_DRAW_BATCH", "true", 1);
    ...
    expect(!mg_pz_draw_batch_active, "only the exact value 1 may enable draw batching");
    ...
    setenv("MOBILEGLUES_PZ_DRAW_BATCH", "1", 1);
    ...
    expect(mg_pz_draw_batch_active, "1 must enable draw batching");
    ...
    expect(!mg_pz_census_active && !mg_pz_vao_fastpath_active && !mg_pz_attrib_fastpath_active &&
               !mg_pz_uniform_fastpath_active && !mg_pz_buffer_streaming_active &&
                ...
                !mg_pz_draw_batch_active && !mg_pz_runtime_mipmap_skip_active,
