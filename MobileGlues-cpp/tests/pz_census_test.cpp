...
int main() {
    ...
    setenv("MOBILEGLUES_PZ_THREADED_PRESENT", "0", 1);
    ...
    expect(!mg_pz_threaded_present_active, "0 must disable threaded present");
    ...
    setenv("MOBILEGLUES_PZ_THREADED_PRESENT", "true", 1);
    mg_pz_census_init();
    ...
    expect(!mg_pz_threaded_present_active, "only the exact value 1 may enable threaded present");
    ...
    setenv("MOBILEGLUES_PZ_THREADED_PRESENT", "1", 1);
    ...
    expect(mg_pz_threaded_present_active, "1 must enable threaded present");
